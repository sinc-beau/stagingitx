...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/enterprise-transformation-dinner-insight-dell-jan-2026',
  },
  openGraph: {
    title: 'Accelerating AI Adoption: Strategies for Optimized Infrastructure',
    description: '<p>Join&nbsp;<strong>Insight</strong>&nbsp;and&nbsp;<strong>Dell Technologies</strong>&nbsp;for an exclusive dinner focused on mastering the foundational elements required for successful AI integra... Miami, January 20, 2026.',
    url: '/enterprise-transformation-dinner-insight-dell-jan-2026',
  ...
  twitter: {
    ...
    title: 'Accelerating AI Adoption: Strategies for Optimized Infrastructure',
    description: '<p>Join&nbsp;<strong>Insight</strong>&nbsp;and&nbsp;<strong>Dell Technologies</strong>&nbsp;for an exclusive dinner focused on mastering the founda... Miami, January 20, 2026.',
