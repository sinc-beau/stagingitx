...
export default function TestimonialsSection() {
  const testimonials = [
    {
      quote: "The event was perfect. The organization, the venue, the sessions… everything was on point. One suggestion I may have would be to add another day to the event so we can have a choice of activities we could do such as golf, hiking, hotsprings, etc. Am sure lots of the participants would gladly pay the extra charge for an extra day.",
