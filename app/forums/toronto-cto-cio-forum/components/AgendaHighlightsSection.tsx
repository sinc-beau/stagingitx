  ...
  const agendaData = [
    ...
    },
    {
      ...
      sessions: [
        ...
        {
          time: '9:00 - 9:50 AM',
          title: 'PANEL - Future of IT Leadership',
          synopsis: 'Senior technology leaders share insights on emerging trends, evolving roles, and preparing for the next decade of IT leadership.'
        },
        {
          time: '10:00 - 10:30 AM',
          title: 'CLOSING SESSION - Key Takeaways & Action Planning',
          synopsis: 'Synthesize learnings from the forum and develop concrete action plans to implement upon return to your organization.'
        }
      ]
    }
  ];
