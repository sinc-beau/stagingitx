  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 bg-black overflow-hidden">
      ...
      <video
        ...
        aria-label="Backbone Forum background video"
      >
        <source
          src="https://45377644.fs1.hubspotusercontent-na1.net/hubfs/45377644/ITx%20Collective/Backbone%20CIO%20CTO%20Forum.mp4"
          type="video/mp4"
        />
      </video>
            ...
            <div className="relative">
              ...
              <div className="absolute top-6 right-6 bg-black/80 backdrop-blur-sm border border-[#4B0BE8]/30 rounded px-4 py-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-bold text-[#4B0BE8]">2026 PROGRAM ACTIVE</span>
                </div>
              </div>
            </div>
          </div>
