...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/copilot-edge-computing-Insight-dell-Intel-new-jersey-jan-2026',
  },
  openGraph: {
    title: 'From Build to Deployment: Inside the New Era of Copilot+ and Edge Computing',
    description: '<p>Dive into the evolving world of Windows 11, Copilot+ PCs, and AI-powered edge computing. You will have the opportunity to hear from our featured keynote speaker, Chris Stadler, Dell Partner Spec... New Jersey, January 22, 2026.',
    url: '/copilot-edge-computing-Insight-dell-Intel-new-jersey-jan-2026',
  ...
  twitter: {
    ...
    title: 'From Build to Deployment: Inside the New Era of Copilot+ and Edge Computing',
    description: '<p>Dive into the evolving world of Windows 11, Copilot+ PCs, and AI-powered edge computing. You will have the opportunity to hear from our featured... New Jersey, January 22, 2026.',
