...
interface ITxNewsletterHubspotFormProps {
  isOpen: boolean;
  onClose: () => void;
}

export function ITxNewsletterHubspotForm({ isOpen, onClose }: ITxNewsletterHubspotFormProps) {
      ...
      <div className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-black border border-white/20 rounded-lg">
        ...
        <div className="sticky top-0 z-10 flex items-center justify-between p-6 border-b border-white/20 bg-black">
          <div>
            <div className="flex items-center gap-2 mb-2">
              <span className="text-xs font-bold text-white/60 uppercase tracking-[0.2em]">Newsletter</span>
            </div>
            <h2 className="text-2xl font-black text-white">
              IT<span className="text-[#4B0BE8]">x</span> COLLECTIVE
            </h2>
            <p className="text-sm text-white/50 mt-1">
              Join the IT leadership community
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 bg-white rounded-b-lg">
          {showSuccess ? (
            ...
            <>
              <style jsx global>{`
            /* HubSpot Form Style Overrides for ITx Newsletter */
            #hubspot-form-newsletter .hs-form {
              font-family: inherit !important;
            }
            
            #hubspot-form-newsletter .hs-form-field label {
            ...
            #hubspot-form-newsletter .hs-form-field label span.hs-form-required {
            ...
            #hubspot-form-newsletter .hs-error-msg {
            ...
            #hubspot-form-newsletter button[type="submit"] {
              width: 100% !important;
            ...
            #hubspot-form-newsletter .hs-button:hover:not(:disabled),
            #hubspot-form-newsletter input[type="submit"]:hover:not(:disabled),
            #hubspot-form-newsletter button[type="submit"]:hover:not(:disabled) {
              background: #3A0BB8 !important;
              transform: translateY(-1px) !important;
              box-shadow: 0 4px 12px rgba(75, 11, 232, 0.3) !important;
            }

            #hubspot-form-newsletter .hs-button:active,
            #hubspot-form-newsletter input[type="submit"]:active,
            #hubspot-form-newsletter button[type="submit"]:active {
              transform: translateY(0) !important;
            }

            #hubspot-form-newsletter .hs-button:disabled,
            #hubspot-form-newsletter input[type="submit"]:disabled,
            #hubspot-form-newsletter button[type="submit"]:disabled {
            ...
            #hubspot-form-newsletter .hs-richtext a {
              color: #4B0BE8 !important;
            ...
            #hubspot-form-newsletter .hs-fieldtype-checkbox label,
            #hubspot-form-newsletter .hs-fieldtype-radio label {
            ...
            #hubspot-form-newsletter .hs-fieldtype-checkbox input,
            #hubspot-form-newsletter .hs-fieldtype-radio input {
              margin-right: 8px !important;
              margin-top: 2px !important;
            }
            
            /* Success message */
            #hubspot-form-newsletter .submitted-message {
              ...
              `}</style>
              <div id="hubspot-form-newsletter" ref={formContainerRef} />
            </>
          )}
        </div>
      </div>
